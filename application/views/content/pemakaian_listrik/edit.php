		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">Ubah Pemakaian Listrik</h1>
						</div>
						<div class="col-sm-6">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" id="id_pelanggan" name="id_pelanggan" class="form-control" placeholder="contoh: 514010018113" value="<?php echo $row->id_pelanggan; ?>">
                  </div>
                  <div class="form-group">
                    <label for="inputDescription">Tahun</label>
                    <input id="tahun" class="form-control" name="tahun" type="number" placeholder="contoh: 2023" value="<?php echo $row->tahun; ?>">
                  </div>
                ...
                <div class="col-md-6">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" id="tagihan" name="tagihan" class="form-control" value="<?php echo $row->tagihan; ?>"  placeholder="1200000">
                  </div>
